...
const SUMMIT_TOOL_NOTE = /^(offers|investors|rehabs|track_record|_heartbeat|uw_store_summit|lead_status|om_deals|todos_personal|summit_logins|summit_deals|summit_props|summit_voicenotes|summit_tasks)$/i;
...
async function loadRoster(force){
  ...
  try {
    ...
    DYN_AGENTS = set; DYN_AGENT_NAMES = names; DEACTIVATED = dset; ROSTER_AT = Date.now();
  } catch (e) {
