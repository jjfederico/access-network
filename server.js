...
const GROVE_ACCESS =
   ...
   /* dark tokens */
 + 'html.dark{--paper:#0E1116;--card:#222A36;--card2:#2B3440;--panel:#2B3440;--sand:#2B3440;--line:#3C4655;--line2:#525D6E;--fieldline:#525D6E;--ink:#EDF0F5;--slate:#EDF0F5;--mut:#A6ADB9;--mut2:#8C95A3;--blue:#6E9BFF;--blued:#9BBBFF;--bluebg:#1B2740;--accent:#6E9BFF;--accent-hover:#9BBBFF;--accdim:#1B2740;--brand:#0F1319;--brandmut:#3A4150;--navy:#0C0F14;--nav:#0F1319;--black:#0F1319;--headerbg:#181D25;--green:#3FBE86;--good:#3FBE86;--goodbg:#14352A;--red:#E0664A;--bad:#E0664A;--badbg:#3A1E16;--amber:#9AA1AD;--warn:#9AA1AD;--warnbg:#2B3440;--teal:#2DD4BF;--coral:#F0785C;--sky:#7FA9F5}'
